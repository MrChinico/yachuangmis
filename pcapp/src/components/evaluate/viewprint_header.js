...
const ViewPrintHeader = (props)=>{
  ...
  return (
    <div className="abstract">
      <div>
        <div><span>科室：</span><span>{Depatname}</span></div>
        ...
        <div><span>床号：</span><span></span></div>
      </div>
      <div>
        <div><span>姓名：</span><span>{lodashget(curpaientinfo,'Patientname','')}</span></div>
        <div><span>性别：</span><span>{lodashget(curpaientinfo,'SexString','男')}</span></div>
        <div><span>年龄：</span><span>{lodashget(curpaientinfo,'Age','')}</span></div>
        <div><span>住院号：</span><span>{lodashget(curpaientinfo,'Patientno','')}</span></div>
      </div>
    </div>
