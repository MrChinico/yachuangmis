	    ...
	    return (
	      	<div>
				<div className="lapseto">
					<span>转归与申报记录</span>
					<button className="ant-btn"><img src="add.png" />转归填写</button>
					<button className="ant-btn"><img src="printing.png" />打印报表</button>
				</div>
				...
				<div><button class="ant-btn-edit blue m30-0">提交数据</button></div>
